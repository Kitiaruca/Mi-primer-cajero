	...
	<body>
		...
		echo $saldo; ?> &euro;
			...
			<h4>
				...
				<label for="cantidadI">Cantidad a Ingresar:</label></h4>
						<p><input min="1" max="9999" name="cantidadI" type="number" id="cantidadI" class="nombre" placeholder="Introduce cantidad" autofocus="" required=""/ >
						<input name="submit" type="submit" id="boton" value="Ingresar" class="boton"/></p>
						<p> 
